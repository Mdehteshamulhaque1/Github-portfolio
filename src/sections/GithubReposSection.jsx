  ...
  return (
    <section id="github" className="section-anchor px-4 pt-16 md:px-6">
      <div className="mx-auto max-w-6xl">
        <SectionHeading
          eyebrow="GitHub Live"
          title="Auto-fetched repositories"
          subtitle="This section pulls repositories directly from the GitHub API and refreshes periodically to stay current."
        />
            ...
            {repos.length ? repos.map((repo, index) => (
              ...
              >
                ...
                <div className="mt-4 flex flex-wrap items-center gap-4 text-sm" style={{ color: 'var(--text-muted)' }}>
                  <span className="pill rounded-full px-2 py-1 text-xs">{repo.language || 'Code'}</span>
