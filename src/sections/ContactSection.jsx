  ...
  return (
    <section id="contact" className="section-anchor px-4 pb-16 pt-16 md:px-6">
      <div className="mx-auto max-w-6xl">
        <SectionHeading
          eyebrow="Contact"
          title="Let’s discuss backend engineering opportunities"
          subtitle="Open to backend development roles, API architecture discussions, and performance-focused collaboration."
        />
        ...
        <div className="shape-contact mx-auto grid max-w-2xl gap-3">
          ...
          >
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-(--brand) px-5 py-3 text-sm font-bold text-white transition hover:-translate-y-0.5 disabled:opacity-70"
            >
        ...
        {toast ? (
          <div className="fixed bottom-5 right-5 z-50 rounded-xl bg-(--text) px-4 py-3 text-sm font-semibold text-(--bg) shadow-xl">
            {toast}
          </div>
        ) : null}
      </div>
