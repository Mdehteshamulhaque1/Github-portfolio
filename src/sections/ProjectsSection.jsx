  ...
  return (
    <section id="projects" className="section-anchor px-4 pt-16 md:px-6">
      <div className="mx-auto max-w-6xl">
        <SectionHeading
          eyebrow="Projects"
          title="Performance-focused backend case studies"
          subtitle="Each project highlights the problem context, backend architecture decisions, and measurable engineering impact."
        />
